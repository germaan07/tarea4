...
public class RandomImageReader {
    private Random random;

    public RandomImageReader(Random random) {
        this.random = random;
    }
    ...
    public Image read(){
        ...
        int with = random.nextInt(100, 10000);
        int heigth = random.nextInt(100, 10000);

        return new Image(size, path, with, heigth);
    }
}
